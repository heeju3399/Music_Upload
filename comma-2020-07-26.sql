...
REPLACE INTO `tbl_board` (`num`, `m_id`, `name`, `subject`, `content`, `pos`, `ref`, `depth`, `regdate`, `pass`, `ip`, `count`, `filename`, `filesize`, `myimgname`, `myimgsize`, `like`, `bad`) VALUES
	(26, '32v', '최상희', '돌덩이', 'Hit me harder Make me strong	<br>\r\n그저 정해진 대로 따르라고	<br>\r\n그게 현명하게 사는 거라고	<br>\r\n쥐 죽은 듯이 살라는 말	<br>\r\n같잖은 말 누굴 위한 삶인가	<br>\r\n뜨겁게 지져봐	<br>\r\n절대 꼼짝 않고 나는 버텨낼 테니까	<br>\r\n거세게 때려봐	<br>\r\n네 손만 다칠 테니까	<br>\r\n나를 봐	<br>\r\n끄떡없어	<br>\r\n쓰러지고 떨어져도	<br>\r\n다시 일어나 오를 뿐야	<br>\r\n난 말야	<br>\r\n똑똑히 봐	<br>\r\n깎일수록 깨질수록	<br>\r\n더욱 세지고 강해지는 돌덩이	<br>\r\n감당할 수 없게 벅찬 이 세상	<br>\r\n유독 내게만 더 모진 이 세상	<br>\r\n모두가 나를 돌아섰고	<br>\r\n비웃었고 아픔이 곧 나였지	<br>\r\n시들고 저무는	<br>\r\n그런 세상 이치에 날 가두려 하지 마	<br>\r\n틀려도 괜찮아	<br>\r\n이 삶은 내가 사니까	<br>\r\n나를 봐	<br>\r\n끄떡없어	<br>\r\n쓰러지고 떨어져도	<br>\r\n다시 일어나 오를 뿐야	<br>\r\n난 말야	<br>\r\n똑똑히 봐	<br>\r\n깎일수록 깨질수록	<br>\r\n더욱 세지고 강해지는 돌덩이	<br>\r\n누가 뭐라 해도 나의 길	<br>\r\n오직 하나뿐인 나의 길	<br>\r\n내 전부를 내걸고서 Hey	<br>\r\n걸어가	<br>\r\n계속해서	<br>\r\n부딪히고 넘어져도	<br>\r\n다시 일어나 걷는 거야	<br>\r\n언젠가	<br>\r\n이 길 끝에 서서	<br>\r\n나도 한 번 크게 한 번	<br>\r\n목이 터져라 울 수 있을 때까지	<br>\r\n', NULL, NULL, NULL, '2020-07-24 14:52:51', NULL, NULL, 0, '돌덩이.mp3', 958328, 'sanghee.jpg', 15821, 0, 0),
	(27, 'kimjunteack', '김준택', '죽일놈', '죽일놈이 생겼다.', NULL, NULL, NULL, '2020-07-24 14:54:42', NULL, NULL, 0, '죽일놈.mp3', 5438788, '준택임.png', 570012, 0, 0),
	...
	(37, 'kwangrok', '김광록', '신촌을 못가', '포스트맨- 신촌을 못가', NULL, NULL, NULL, '2020-07-24 15:18:52', NULL, NULL, 1111, '신촌을 못가.mp3', 5409068, '1595571447341.jpg', 78838, 10, 0),
	(38, 'hanjun', '박한준', '입술의 말', 'MC THE MAX- 입술의말', NULL, NULL, NULL, '2020-07-24 15:23:52', NULL, NULL, 3, '입술의말.mp3', 6598240, '한준.png', 78833, 4, 0),
	(39, 'heeju', '이희주', '건배', '건배가 하고싶었다.', NULL, NULL, NULL, '2020-07-24 15:25:29', NULL, NULL, 1, '건배.mp3', 3904861, '20200709_164850_074.jpg', 476330, 5111, 0),
	...
	(42, 'heeju', '이희주', '거꾸로강을거슬러오르는저연어처럼', '거꾸로강을거슬러오르는저연어처럼 살고싶다', NULL, NULL, NULL, '2020-07-24 15:29:49', NULL, NULL, 3, '거꾸로강을거스러.mp3', 6438100, '20200709_164850_0741.jpg', 476330, 321, 0),
	...
	(45, 'leesenggu', '이승규', '홍연', '홍연', NULL, NULL, NULL, '2020-07-24 15:43:01', NULL, NULL, 13, '홍연.mp3', 6278728, '20200723_172057.jpg', 234817, 4, 0),
	...
	(55, 'power8128', '김원상', '죽을만큼아파서', '사진', NULL, NULL, NULL, '2020-07-24 15:58:43', NULL, NULL, 5, '죽을만큼아파서.mp3', 6497439, '김원상 자기소개서 사진5.jpg', 13738, 4321, 1),
	...
	(57, 'heeju', '이희주', '천년바위', '천년바위가 보고싶다', NULL, NULL, NULL, '2020-07-24 15:29:02', NULL, NULL, 10, '천년바위.mp3', 5857476, '20200707_131131.jpg', 201438, 2, 0),
	(58, 'power8128', '김원상', '여인의 향기', '사진', NULL, NULL, NULL, '2020-07-24 15:57:41', NULL, NULL, 0, '여인의 향기.mp3', 5420888, '김원상 자기소개서 사진4.jpg', 13738, 0, 0),
	(59, 'hanjun', '박한준', '포장마차', '포장마차에서 한곡', NULL, NULL, NULL, '2020-07-24 15:47:56', NULL, NULL, 5, '포장마차.mp3', 5572992, '한준2.png', 78833, 1, 0),
	(60, '32v', '최상희', '나란놈이란', '나란놈이란.........? ', NULL, NULL, NULL, '2020-07-24 16:42:52', NULL, NULL, 2, '나란놈이란.mp3', 2850532, 'sanghee.jpg', 45306, 222, 1);
...
REPLACE INTO `tbl_member` (`m_id`, `m_pwd`, `m_email`, `m_birth`, `m_visited`, `m_auth`, `m_latitude`, `m_longitude`, `m_tag`, `m_created_at`, `m_updated_at`) VALUES
	...
	('choi', '1234', '32v.lab@gmail.com', '1990-01-01', '2020-07-26', 'N', 0, 0, NULL, '2020-07-26 20:14:49', NULL),
